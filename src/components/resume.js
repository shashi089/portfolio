        ...
        <div className="col-12 col-lg-6 resume_card">
          ...
          <div className="resume_card_body">
            ...
            <p className="resume_card_description">
              I have completed B.E in Electronics and communication from BLDEA's
        ...
        <div className="col-12 col-lg-6 resume_card">
          ...
          <div className="resume_card_body">
            ...
            <p className="resume_card_description">
              ...
              <br />
              Responsibilities:Supported customers with basic technical support
              for networking products like router, adapters. and
              Software(Desktop app)
            </p>
          </div>
        </div>
        <div className="col-12 col-lg-6 resume_card"></div>
        <div className="col-12 col-lg-6 resume_card">
          <div className="resume_card_body">
            <div className="resume_card_title">
